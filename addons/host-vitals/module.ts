 ...
 * memory, disk usage, uptime and temperatures.
 *
 ...
 * plain numbers. This module only renders them. It stores nothing — each render reads live —
 * so it has no settings, no tables and no migrations.
 */
