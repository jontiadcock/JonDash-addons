 ...
 * Explorer and `df -h` do, so JonDash agrees with the tools someone would check it against. A
 * drive sold as "2 TB" reads as 1.8 TB here — but so does Explorer's, and agreeing with the
 * machine beats agreeing with the packaging.
 *
 ...
 * REFS addons/host-vitals/page.tsx
 */
 ...
 * REFS addons/host-vitals/ui/widget.tsx
 */
