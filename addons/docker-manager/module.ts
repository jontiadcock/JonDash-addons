...
const dockerManager: ModuleDefinition = {
  ...
  // The floor comes from host-install, which needs core's package API (1.7.1-beta.6). The
  ...
  helpers: [
    { id: "docker", minVersion: "0.0.1-beta.1" },
    { id: "host-install", minVersion: "0.0.1-beta.1" },
  ],
